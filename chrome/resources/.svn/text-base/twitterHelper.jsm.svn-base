...
TwitterHelper.getAuthUrl=function(consumer,callback){
...
TwitterHelper.getAccessToken=function(consumer,verifier,callback){
	...
	var aCallback=function(answer){
		consumer.accessToken=getURLParam(answer,"oauth_token");
		consumer.accessTokenSecret=getURLParam(answer,"oauth_token_secret");
		screen_name=getURLParam(answer,"screen_name")
